        ...
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
            ...
            <div class="w-full md:w-1/2 space-y-4">
                ...
                <p class="text-sm md:text-base text-gray-500">
                    ...
                    yang saya dan generasi penerus saya setidaknya tidak buruk untuk ditinggali. Sampah telah menjadi
                    momok masyarakat yang sulit untuk diurai atau dikelola. Kini di tahun 2025, kami akan membantu
    ...
    <section class="relative text-center py-10 bg-white">
        ...
        <div class="z-10 relative mb-6">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto mt-2">
                Perusahaan ini berdiri sejak tahun 2019 tapatnya 10-November-2019. Berlokasi di Baratan Wetan, Baratan,
                Kec. Patrang, Kabupaten Jember, Jawa Timur. Menjadi salah satu kandang maggot terkenal di kota jember.
        ...
        <div data-aos="fade-left">
            <div class="max-w-6xl mx-auto flex flex-col md:flex-row gap-8 px-4 md:items-start">
                <div class="md:w-1/2 flex flex-col justify-start mt-20">
                    <h2 class="text-2xl md:text-3xl font-bold text-[#111B21] leading-tight">Apa itu.. <span
                            class="text-lime-500">Bagi Sampah?</span></h2>
                    <p class="text-gray-600 mt-4 leading-relaxed">Bagi sampah adalah salah satu fitur menarik, Mengapa?
                        bagi anda jika merasa sampah dirumah terlalu menumpuk, kami bisa mengatasi. Anda hanya perlu
                        mengirimkan sampah DAN! kami juga bisa mengambil ke rumah anda!
                    </p>
                </div>
